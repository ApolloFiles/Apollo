...
<aside class="sidebar border-end d-none d-md-block">
  <div class="p-3">
    ...
    <ul class="list-unstyled">
      <li><a href="/media/" class="text-decoration-none">Overview<!-- Startseite --></a></li>
    ...
    {#if pageData.libraries.length > 0}
      <ul class="list-unstyled">
        {#each pageData.libraries as library}
          <li><a href={`/media/${library.id}/`} class="text-decoration-none">{library.displayName}</a>
          </li>
        {/each}
      </ul>
    {:else}
