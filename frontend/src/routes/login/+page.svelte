            ...
            {#if oAuthProvider.length > 0}
                <div class="third-party-login-container">
                    ...
                    <div class="d-flex flex-wrap">
                        ...
                        --><img src={assetThirdPartyLoginLogos[`/src/lib/assets/login/third-party/${provider.id}.svg`].default}
                                class="third-party-img" alt="{provider.displayName}'s logo">&nbsp;{provider.displayName}<!--
                      --></a>
                        {/each}
                    </div>
                </div>
