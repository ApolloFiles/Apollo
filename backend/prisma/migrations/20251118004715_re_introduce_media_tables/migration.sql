...
-- CreateTable
CREATE TABLE "public"."media_libraries_shared_with" (
...
-- CreateTable
CREATE TABLE "public"."media_libraries_media" (
...
-- CreateTable
CREATE TABLE "public"."media_libraries_media_items" (
...
-- CreateTable
CREATE TABLE "public"."media_libraries_user_watch_progress" (
    "user_id" BIGINT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "media_libraries_media_library_id_directory_path_key" ON "public"."media_libraries_media"("library_id", "directory_path");

-- CreateIndex
CREATE UNIQUE INDEX "media_libraries_media_items_media_id_file_path_key" ON "public"."media_libraries_media_items"("media_id", "file_path");

-- AddForeignKey
ALTER TABLE "public"."media_libraries_shared_with" ADD CONSTRAINT "media_libraries_shared_with_library_id_fkey" FOREIGN KEY ("library_id") REFERENCES "public"."media_libraries"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."media_libraries_media" ADD CONSTRAINT "media_libraries_media_library_id_fkey" FOREIGN KEY ("library_id") REFERENCES "public"."media_libraries"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."media_libraries_media_items" ADD CONSTRAINT "media_libraries_media_items_media_id_fkey" FOREIGN KEY ("media_id") REFERENCES "public"."media_libraries_media"("id") ON DELETE CASCADE ON UPDATE CASCADE;
